...
function useToggleUserLink({ props }) {
  const { dispatch, state } = useLayoutContext().widget;
  const { className } = React98.useMemo(() => setupUserToggle(), []);
...
function ControlBar(_a) {
  ...
  return /* @__PURE__ */ React101.createElement("div", __spreadValues({}, htmlProps), visibleControls.microphone && /* @__PURE__ */ React101.createElement("div", { className: "lk-button-group" }, /* @__PURE__ */ React101.createElement(TrackToggle, { source: Track9.Source.Microphone, showIcon }, showText && "Microphone"), /* @__PURE__ */ React101.createElement("div", { className: "lk-button-group-menu" }, /* @__PURE__ */ React101.createElement(MediaDeviceMenu, { kind: "audioinput" }))), visibleControls.camera && /* @__PURE__ */ React101.createElement("div", { className: "lk-button-group" }, /* @__PURE__ */ React101.createElement(TrackToggle, { source: Track9.Source.Camera, showIcon }, showText && "Camera"), /* @__PURE__ */ React101.createElement("div", { className: "lk-button-group-menu" }, /* @__PURE__ */ React101.createElement(MediaDeviceMenu, { kind: "videoinput" }))), visibleControls.screenShare && browserSupportsScreenSharing && /* @__PURE__ */ React101.createElement(
    TrackToggle,
    {
