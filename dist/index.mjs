...
import React124, { useCallback as useCallback11, useEffect as useEffect31, useRef as useRef12, useState as useState26 } from "react";
function FullscreenIndicator({ parentCallback }) {
