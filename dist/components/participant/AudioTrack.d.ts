 ...
 * @public
 */
export declare const AudioTrack: (props: AudioTrackProps & React.RefAttributes<HTMLAudioElement>) => React.ReactElement<any, string | React.JSXElementConstructor<any>> | null;
