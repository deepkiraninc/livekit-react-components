...
function useToggleUserLink({ props }) {
  const { dispatch, state } = useLayoutContext().widget;
  const { className } = React121.useMemo(() => (0, import_components_core56.setupUserToggle)(), []);
...
function VideoConference(_a2) {
  ...
  useWarnAboutMissingStyles();
  return /* @__PURE__ */ React135.createElement("div", __spreadValues({ className: "lk-video-conference" }, props), (0, import_components_core60.isWeb)() && /* @__PURE__ */ React135.createElement(
