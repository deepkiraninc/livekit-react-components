    ...
    trackLock.lock().then((unlock) => __async(this, null, function* () {
      try {
        ...
        if (options.audio || options.video) {
          const localTracks = yield (0, import_livekit_client17.createLocalTracks)(options);
          if (needsCleanup) {
...
function HostEndMeetingMenu(_a2) {
  ...
  return /* @__PURE__ */ React120.createElement(React120.Fragment, null, /* @__PURE__ */ React120.createElement(
    ...
    props.children,
    showIcon && /* @__PURE__ */ React120.createElement(LeaveIcon_default, null),
    showText && "Leave"
...
function useToggleUserLink({ props }) {
  const { dispatch, state } = useLayoutContext().widget;
  const { className } = React121.useMemo(() => (0, import_components_core57.setupUserToggle)(), []);
...
function ControlBar(_a2) {
  ...
  ))), visibleControls.camera && /* @__PURE__ */ React128.createElement("div", { className: "lk-button-group" }, /* @__PURE__ */ React128.createElement(TrackToggle, { source: import_livekit_client19.Track.Source.Camera, showIcon, onChange: cameraOnChange }, showText && "Camera"), /* @__PURE__ */ React128.createElement("div", { className: "lk-button-group-menu" }, /* @__PURE__ */ React128.createElement(
    MediaDeviceMenu,
    {
      kind: "videoinput",
...
function InviteViaPhone(_a2) {
  var _b = _a2, { link, room_name, participant } = _b, props = __objRest(_b, ["link", "room_name", "participant"]);
  ...
  return /* @__PURE__ */ React132.createElement("div", __spreadValues({}, props), showToast ? /* @__PURE__ */ React132.createElement(Toast, { className: "lk-toast-connection-state" }, "Invitation Sent") : /* @__PURE__ */ React132.createElement(React132.Fragment, null), /* @__PURE__ */ React132.createElement("form", { className: "lk-chat-form", onSubmit: handleSubmit }, /* @__PURE__ */ React132.createElement("select", { className: "lk-form-control lk-chat-form-input tl-select", ref: selectRef }, /* @__PURE__ */ React132.createElement("option", { value: "+1" }, "United States (+1)"), /* @__PURE__ */ React132.createElement("option", { value: "+91" }, "India (+91)")), /* @__PURE__ */ React132.createElement("input", { className: "lk-form-control lk-chat-form-input", type: "tel", ref: inputRef, placeholder: "Enter Mobile Number" }), /* @__PURE__ */ React132.createElement("button", { type: "button", onClick: handleSubmit, className: "lk-button lk-chat-form-button tl-invite-button" }, "Invite")));
}
...
function InviteViaEmail(_a2) {
  ...
  const [showToast, setShowToast] = React133.useState(false);
  function handleSubmit(event) {
    return __async(this, null, function* () {
      event.preventDefault();
      if (inputRef.current && inputRef.current.value.trim() !== "") {
  ...
  return /* @__PURE__ */ React133.createElement("div", __spreadValues({}, props), showToast ? /* @__PURE__ */ React133.createElement(Toast, { className: "lk-toast-connection-state" }, "Invitation Sent") : /* @__PURE__ */ React133.createElement(React133.Fragment, null), /* @__PURE__ */ React133.createElement("form", { className: "lk-chat-form", onSubmit: handleSubmit }, /* @__PURE__ */ React133.createElement("input", { className: "lk-form-control lk-chat-form-input", type: "email", ref: inputRef, placeholder: "Enter Email" }), /* @__PURE__ */ React133.createElement("button", { type: "button", onClick: handleSubmit, className: "lk-button lk-chat-form-button tl-invite-button" }, "Invite")));
}
...
function ShareLink(_a2) {
  ...
  const [users, setUsers] = React134.useState([]);
  const [searched, setSearched] = React134.useState([]);
  const [showToast, setShowToast] = React134.useState(false);
  const [inviteVia, setInviteVia] = React134.useState("chat");
  ...
  const { infoObserver } = React134.useMemo(() => {
  ...
  const [showInviteUser, setShowInviteUser] = React134.useState(true);
  React134.useEffect(() => {
  ...
  return /* @__PURE__ */ React134.createElement("div", __spreadProps(__spreadValues({}, props), { className: "lk-chat lk-sharelink" }), /* @__PURE__ */ React134.createElement("form", { className: "lk-chat-form" }, /* @__PURE__ */ React134.createElement("input", { className: "lk-form-control lk-chat-form-input", type: "text", value: link, readOnly: true }), /* @__PURE__ */ React134.createElement("button", { type: "button", className: "lk-button lk-chat-form-button", onClick: handleCopy }, "Copy")), showToast ? /* @__PURE__ */ React134.createElement(Toast, { className: "lk-toast-connection-state" }, "Copied") : /* @__PURE__ */ React134.createElement(React134.Fragment, null), /* @__PURE__ */ React134.createElement("div", { className: "tl-invite-buttons" }, /* @__PURE__ */ React134.createElement("button", { type: "button", className: "lk-button lk-chat-form-button", "aria-pressed": inviteVia === "chat", onClick: () => showInviteVia("chat") }, "TL-Chat"), /* @__PURE__ */ React134.createElement("button", { type: "button", className: "lk-button lk-chat-form-button", "aria-pressed": inviteVia === "phone", onClick: () => showInviteVia("phone") }, "Phone"), /* @__PURE__ */ React134.createElement("button", { type: "button", className: "lk-button lk-chat-form-button", "aria-pressed": inviteVia === "email", onClick: () => showInviteVia("email") }, "Email")), inviteVia === "phone" ? /* @__PURE__ */ React134.createElement(InviteViaPhone, { link, room_name: room.name, participant: participantName }) : /* @__PURE__ */ React134.createElement(React134.Fragment, null), inviteVia === "email" ? /* @__PURE__ */ React134.createElement(InviteViaEmail, { link, room_name: room.name, participant: participantName }) : /* @__PURE__ */ React134.createElement(React134.Fragment, null), inviteVia === "chat" ? /* @__PURE__ */ React134.createElement(React134.Fragment, null, showInviteUser ? /* @__PURE__ */ React134.createElement("form", { className: "lk-chat-form", onSubmit: handleSubmit }, /* @__PURE__ */ React134.createElement(
    "input",
    {
  ...
  )) : /* @__PURE__ */ React134.createElement(React134.Fragment, null), showInviteUser && searched.length > 0 ? /* @__PURE__ */ React134.createElement("ul", { className: "lk-list lk-chat-messages", ref: ulRef }, searched.map((user, index) => {
    return /* @__PURE__ */ React134.createElement("li", { key: index, className: "lk-chat-entry" }, /* @__PURE__ */ React134.createElement("div", null, /* @__PURE__ */ React134.createElement("span", { className: "lk-message-body" }, user.full_name, " ", user.ext_no ? ` - ${user.ext_no}` : ""), /* @__PURE__ */ React134.createElement("span", { className: "lk-message-body lk-message-text" }, user.designation)), /* @__PURE__ */ React134.createElement("button", { type: "button", onClick: () => handleInvite(user), className: "lk-button lk-chat-form-button" + (user.invited ? " invited" : "") }, user.invited ? "Invited" : "Invite"));
  })) : "") : /* @__PURE__ */ React134.createElement(React134.Fragment, null));
}
...
function VideoConference(_a2) {
  ...
  var _a3, _b2;
  const [widgetState, setWidgetState] = React135.useState({
    showChat: null,
    unreadMessages: 0,
    showSettings: false
  });
  const lastAutoFocusedScreenShareTrack = React135.useRef(null);
  const { localParticipant } = useLocalParticipant();
  const p2 = useEnsureParticipant(localParticipant);
  const { infoObserver } = React135.useMemo(() => {
  ...
  const [showShareButton, setShowShareButton] = React135.useState(false);
  const [showParticipantButton, setShowParticipantButton] = React135.useState(false);
  const [leaveButton, setLeaveButton] = React135.useState("Leave");
  const [endForAll, setEndForAll] = React135.useState(false);
  const meta = metadata ? JSON.parse(metadata) : {};
  const [waitingRoomCount, setWaitingRoomCount] = React135.useState(0);
  const tracks = useTracks(
    [
  ...
  const [isWhiteboard, setIsWhiteboard] = React135.useState(false);
  ...
  useWarnAboutMissingStyles();
  return /* @__PURE__ */ React135.createElement("div", __spreadValues({ className: "lk-video-conference" }, props), (0, import_components_core61.isWeb)() && /* @__PURE__ */ React135.createElement(
    ...
    /* @__PURE__ */ React135.createElement("div", { className: "lk-video-conference-inner" }, !focusTrack ? /* @__PURE__ */ React135.createElement("div", { className: "lk-grid-layout-wrapper" }, /* @__PURE__ */ React135.createElement(GridLayout, { tracks }, /* @__PURE__ */ React135.createElement(ParticipantTile, null))) : /* @__PURE__ */ React135.createElement("div", { className: "lk-focus-layout-wrapper" }, /* @__PURE__ */ React135.createElement(FocusLayoutContainer, null, /* @__PURE__ */ React135.createElement(CarouselLayout, { tracks: carouselTracks }, /* @__PURE__ */ React135.createElement(ParticipantTile, null)), focusTrack && /* @__PURE__ */ React135.createElement(FocusLayout, { trackRef: focusTrack }))), /* @__PURE__ */ React135.createElement(
      ControlBar,
      {
        controls: {
          chat: true,
    ...
    showShareButton ? /* @__PURE__ */ React135.createElement(ShareLink, { style: {
      display: widgetState.showChat == "show_invite" ? "block" : "none"
    } }) : /* @__PURE__ */ React135.createElement(React135.Fragment, null),
    showParticipantButton ? /* @__PURE__ */ React135.createElement(
      Users,
      {
    ...
    SettingsComponent && /* @__PURE__ */ React135.createElement(
      "div",
      {
        className: "lk-settings-menu-modal",
        style: { display: widgetState.showSettings ? "block" : "none" }
      },
      /* @__PURE__ */ React135.createElement(SettingsComponent, null)
    )
  ), /* @__PURE__ */ React135.createElement(RoomAudioRenderer, null), /* @__PURE__ */ React135.createElement(ConnectionStateToast, null));
}
...
function AudioConference(_a2) {
  ...
  useWarnAboutMissingStyles();
  return /* @__PURE__ */ React136.createElement(LayoutContextProvider, { onWidgetChange: setWidgetState }, /* @__PURE__ */ React136.createElement("div", __spreadValues({ className: "lk-audio-conference" }, props), /* @__PURE__ */ React136.createElement("div", { className: "lk-audio-conference-stage" }, /* @__PURE__ */ React136.createElement(TrackLoop, { tracks: audioTracks }, /* @__PURE__ */ React136.createElement(ParticipantAudioTile, null))), /* @__PURE__ */ React136.createElement(
    ControlBar,
    {
      controls: { microphone: true, screenShare: false, camera: false, chat: true },
      waitingRoomCount: 0
    }
  ), widgetState.showChat == "show_chat" && /* @__PURE__ */ React136.createElement(Chat, null)));
}
