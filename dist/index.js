...
function ShareLink(_a2) {
  ...
  return /* @__PURE__ */ React132.createElement("div", __spreadProps(__spreadValues({}, props), { className: "lk-chat lk-sharelink" }), /* @__PURE__ */ React132.createElement("form", { className: "lk-chat-form" }, /* @__PURE__ */ React132.createElement("input", { className: "lk-form-control lk-chat-form-input", type: "text", value: link, readOnly: true }), /* @__PURE__ */ React132.createElement("button", { type: "button", className: "lk-button lk-chat-form-button", onClick: handleCopy }, "Copy")), showToast ? /* @__PURE__ */ React132.createElement(Toast, { className: "lk-toast-connection-state" }, "Copied") : /* @__PURE__ */ React132.createElement(React132.Fragment, null), showInviteUser ? /* @__PURE__ */ React132.createElement("form", { className: "lk-chat-form", onSubmit: handleSubmit }, /* @__PURE__ */ React132.createElement(
    ...
    return /* @__PURE__ */ React132.createElement("li", { key: index, className: "lk-chat-entry" }, /* @__PURE__ */ React132.createElement("div", { className: "tl-list-user-box" }, /* @__PURE__ */ React132.createElement("span", { className: "lk-message-body" }, user.full_name, " ", user.ext_no ? ` - ${user.ext_no}` : ""), /* @__PURE__ */ React132.createElement("span", { className: "lk-message-body lk-message-text" }, user.designation)), /* @__PURE__ */ React132.createElement("button", { type: "button", onClick: () => handleInvite(user), className: "lk-button lk-chat-form-button tl-invite-button" + (user.invited ? " invited" : "") }, user.invited ? "Invited" : "Invite"));
  })) : "");
}
...
function VideoConference(_a2) {
  ...
  useWarnAboutMissingStyles();
  return /* @__PURE__ */ React133.createElement("div", __spreadValues({ className: "lk-video-conference" }, props), (0, import_components_core61.isWeb)() && /* @__PURE__ */ React133.createElement(
