...
function Chat(_a) {
  ...
  })), /* @__PURE__ */ React11.createElement("form", { className: "lk-chat-form", onSubmit: press }, /* @__PURE__ */ React11.createElement(
    "input",
    {
...
function useConnectionState(room) {
  ...
  const observable = React15.useMemo(() => (0, import_components_core4.connectionStateObserver)(r), [r]);
...
function useIsSpeaking(participant) {
  const p = useEnsureParticipant(participant);
  const observable = React20.useMemo(() => (0, import_components_core9.createIsSpeakingObserver)(p), [p]);
...
function useIsEncrypted(participant) {
  ...
  const observer = React70.useMemo(() => (0, import_components_core30.encryptionStatusObservable)(room, p), [room, p]);
...
function ShareLink(_a) {
  ...
  const ulRef = React96.useRef(null);
  const { link } = useGetLink();
  const [users, setUsers] = React96.useState([]);
  const [searched, setSearched] = React96.useState([]);
  const [showToast, setShowToast] = React96.useState(false);
  ...
  const [showInviteUser, setShowInviteUser] = React96.useState(true);
  React96.useEffect(() => {
  ...
  return /* @__PURE__ */ React96.createElement("div", __spreadProps(__spreadValues({}, props), { className: "lk-chat lk-sharelink" }), /* @__PURE__ */ React96.createElement("form", { className: "lk-chat-form" }, /* @__PURE__ */ React96.createElement("input", { className: "lk-form-control lk-chat-form-input", type: "text", value: link, readOnly: true }), /* @__PURE__ */ React96.createElement("button", { type: "button", className: "lk-button lk-chat-form-button", onClick: handleCopy }, "Copy")), showToast ? /* @__PURE__ */ React96.createElement(Toast, { className: "lk-toast-connection-state" }, "Copied") : /* @__PURE__ */ React96.createElement(React96.Fragment, null), showInviteUser ? /* @__PURE__ */ React96.createElement("form", { className: "lk-chat-form", onSubmit: handleSubmit }, /* @__PURE__ */ React96.createElement(
    "input",
    {
      className: "lk-form-control lk-chat-form-input",
      ref: inputRef,
  ...
  )) : /* @__PURE__ */ React96.createElement(React96.Fragment, null), showInviteUser && searched.length > 0 ? /* @__PURE__ */ React96.createElement("ul", { className: "lk-list lk-chat-messages", ref: ulRef }, searched.map((user, index) => {
    return /* @__PURE__ */ React96.createElement("li", { key: index, className: "lk-chat-entry" }, /* @__PURE__ */ React96.createElement("div", null, /* @__PURE__ */ React96.createElement("span", { className: "lk-message-body" }, user.full_name, " ", user.ext_no ? ` - ${user.ext_no}` : ""), /* @__PURE__ */ React96.createElement("span", { className: "lk-message-body lk-message-text" }, user.designation)), /* @__PURE__ */ React96.createElement("button", { type: "button", onClick: () => handleInvite(user), className: "lk-button lk-chat-form-button" + (user.invited ? " invited" : "") }, user.invited ? "Invited" : "Invite"));
  })) : "");
}
...
function VideoConference(_a) {
  ...
  const lastAutoFocusedScreenShareTrack = React97.useRef(null);
  const { localParticipant } = useLocalParticipant();
  const p = useEnsureParticipant(localParticipant);
  ...
  const [showShareButton, setShowShareButton] = React97.useState(false);
  const [showParticipantButton, setShowParticipantButton] = React97.useState(false);
  const [leaveButton, setLeaveButton] = React97.useState("Leave");
  const [endForAll, setEndForAll] = React97.useState(false);
  const meta = metadata ? JSON.parse(metadata) : {};
  const [waitingRoomCount, setWaitingRoomCount] = React97.useState(0);
  const tracks = useTracks(
    [
  ...
  return /* @__PURE__ */ React97.createElement("div", __spreadValues({ className: "lk-video-conference" }, props), (0, import_components_core42.isWeb)() && /* @__PURE__ */ React97.createElement(
    LayoutContextProvider,
    {
      value: layoutContext,
      onWidgetChange: widgetUpdate
    },
    /* @__PURE__ */ React97.createElement("div", { className: "lk-video-conference-inner" }, !focusTrack ? /* @__PURE__ */ React97.createElement("div", { className: "lk-grid-layout-wrapper" }, /* @__PURE__ */ React97.createElement(GridLayout, { tracks }, /* @__PURE__ */ React97.createElement(ParticipantTile, null))) : /* @__PURE__ */ React97.createElement("div", { className: "lk-focus-layout-wrapper" }, /* @__PURE__ */ React97.createElement(FocusLayoutContainer, null, /* @__PURE__ */ React97.createElement(CarouselLayout, { tracks: carouselTracks }, /* @__PURE__ */ React97.createElement(ParticipantTile, null)), focusTrack && /* @__PURE__ */ React97.createElement(FocusLayout, { trackRef: focusTrack }))), /* @__PURE__ */ React97.createElement(
      ControlBar,
      {
        controls: {
          chat: true,
    ...
    showShareButton ? /* @__PURE__ */ React97.createElement(ShareLink, { style: {
      display: widgetState.showChat == "show_invite" ? "flex" : "none"
    } }) : /* @__PURE__ */ React97.createElement(React97.Fragment, null),
    showParticipantButton ? /* @__PURE__ */ React97.createElement(
      Users,
      {
  ...
  ), /* @__PURE__ */ React97.createElement(RoomAudioRenderer, null), /* @__PURE__ */ React97.createElement(ConnectionStateToast, null));
}
...
function AudioConference(_a) {
  var props = __objRest(_a, []);
  const [widgetState, setWidgetState] = React98.useState({
    showChat: null,
    unreadMessages: 0
  });
  const participants = useParticipants();
  return /* @__PURE__ */ React98.createElement(LayoutContextProvider, { onWidgetChange: setWidgetState }, /* @__PURE__ */ React98.createElement("div", __spreadValues({ className: "lk-audio-conference" }, props), /* @__PURE__ */ React98.createElement("div", { className: "lk-audio-conference-stage" }, /* @__PURE__ */ React98.createElement(ParticipantLoop, { participants }, /* @__PURE__ */ React98.createElement(ParticipantAudioTile, null))), /* @__PURE__ */ React98.createElement(
    ControlBar,
    {
      controls: { microphone: true, screenShare: false, camera: false, chat: true },
      waitingRoomCount: 0
    }
  ), widgetState.showChat == "show_chat" && /* @__PURE__ */ React98.createElement(Chat, null)));
}
