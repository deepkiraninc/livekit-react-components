...
// src/prefabs/Chat.tsx
function Chat(_a2) {
  var _b = _a2, { messageFormatter, messageDecoder, messageEncoder } = _b, props = __objRest(_b, ["messageFormatter", "messageDecoder", "messageEncoder"]);
...
function useConnectionQualityIndicator(options = {}) {
  ...
  const { className, connectionQualityObserver } = React14.useMemo(
    () => (0, import_components_core3.setupConnectionQualityIndicator)(p2),
    [p2]
  );
...
function useConnectionState(room) {
  ...
  const observable = React15.useMemo(() => (0, import_components_core4.connectionStateObserver)(r2), [r2]);
...
function useFocusToggle({ trackRef, trackSource, participant, props }) {
  ...
  const layoutContext = useMaybeLayoutContext();
  const { className } = React17.useMemo(() => (0, import_components_core6.setupFocusToggle)(), []);
  ...
  }, [trackRef, layoutContext == null ? void 0 : layoutContext.pin.state, p2, trackSource]);
  const mergedProps = React17.useMemo(
    ...
    [props, className, trackRef, trackSource, inFocus, layoutContext == null ? void 0 : layoutContext.pin, p2]
  );
...
function useIsMuted(sourceOrTrackRef, options = {}) {
  ...
  const [isMuted, setIsMuted] = React19.useState(
    !!(((_a2 = ref.publication) == null ? void 0 : _a2.isMuted) || ((_b = p2.getTrack(ref.source)) == null ? void 0 : _b.isMuted))
  );
  React19.useEffect(() => {
...
function useIsSpeaking(participant) {
  const p2 = useEnsureParticipant(participant);
  const observable = React20.useMemo(() => (0, import_components_core9.createIsSpeakingObserver)(p2), [p2]);
...
function useMediaDevices({ kind }) {
  const deviceObserver = React24.useMemo(() => (0, import_components_core13.createMediaDeviceObserver)(kind), [kind]);
  const devices = useObservableState(deviceObserver, []);
  return devices;
}
...
function useMediaTrackBySourceOrName(observerOptions, options = {}) {
  var _a2;
  const [publication, setPublication] = React25.useState((0, import_components_core15.getTrackByIdentifier)(observerOptions));
  ...
  React25.useEffect(() => {
    ...
    if (track) {
      ...
      if (((_a3 = options.element) == null ? void 0 : _a3.current) && !((0, import_components_core15.isLocal)(observerOptions.participant) && (track == null ? void 0 : track.kind) === "audio")) {
...
function useParticipantTile({
  ...
  const trackReference = React28.useMemo(() => {
    ...
    const _source = (_b = (_a2 = trackRef == null ? void 0 : trackRef.source) != null ? _a2 : maybeTrackRef == null ? void 0 : maybeTrackRef.source) != null ? _b : source;
    if (_source === void 0) {
      throw new Error(
    ...
    return {
      participant: (_d = (_c2 = trackRef == null ? void 0 : trackRef.participant) != null ? _c2 : maybeTrackRef == null ? void 0 : maybeTrackRef.participant) != null ? _d : p2,
      publication: (_f = (_e2 = trackRef == null ? void 0 : trackRef.publication) != null ? _e2 : maybeTrackRef == null ? void 0 : maybeTrackRef.publication) != null ? _f : publication,
      source: _source
    };
  }, [
...
function useStartAudio({ room, props }) {
  ...
  const { className, roomAudioPlaybackAllowedObservable, handleStartAudioPlayback } = React31.useMemo(
...
function useSwipe(element, options = {}) {
  var _a2;
  const touchStart = React32.useRef(null);
  const touchEnd = React32.useRef(null);
  ...
  const onTouchEnd = React32.useCallback(() => {
...
function useChatToggle({ props }) {
  ...
  const { className } = React33.useMemo(() => (0, import_components_core20.setupChatToggle)(), []);
...
function useTrackMutedIndicator(trackRefOrSource, options = {}) {
  ...
  const isMuted = useObservableState(
    mediaMutedObserver,
    !!(((_b = ref.publication) == null ? void 0 : _b.isMuted) || ((_c2 = ref.participant.getTrack(ref.source)) == null ? void 0 : _c2.isMuted))
  );
...
function useTrackToggle(_a2) {
  ...
  const track = (_a3 = room == null ? void 0 : room.localParticipant) == null ? void 0 : _a3.getTrack(source);
  const { toggle, className, pendingObserver, enabledObserver } = React35.useMemo(
  ...
  const newProps = React35.useMemo(() => mergeProps(rest, { className }), [rest, className]);
  const clickHandler = React35.useCallback(
    (evt) => {
      var _a4;
      toggle();
...
function useTracks(sources = [
  ...
  const room = useEnsureRoom(options.room);
  const [trackReferences, setTrackReferences] = React36.useState([]);
  const [participants, setParticipants] = React36.useState([]);
  const sources_ = React36.useMemo(() => {
    return sources.map((s2) => (0, import_components_core23.isSourceWitOptions)(s2) ? s2.source : s2);
  ...
  const maybeTrackReferences = React36.useMemo(() => {
...
// src/components/controls/MediaDeviceSelect.tsx
function MediaDeviceSelect(_a2) {
  var _b = _a2, {
    kind,
    initialSelection,
  ...
  return /* @__PURE__ */ React37.createElement("ul", __spreadValues({}, mergedProps), devices.map((device, index) => /* @__PURE__ */ React37.createElement(
    "li",
    {
      key: device.deviceId,
      id: device.deviceId,
    ...
    /* @__PURE__ */ React37.createElement("button", { className: "lk-button", onClick: () => handleActiveDeviceChange(device.deviceId) }, device.label)
  )));
}
...
function MediaDeviceMenu(_a2) {
  ...
  const [devices, setDevices] = React38.useState([]);
  const [updateRequired, setUpdateRequired] = React38.useState(true);
  ...
  const button = React38.useRef(null);
  const tooltip = React38.useRef(null);
  React38.useLayoutEffect(() => {
    if (button.current && tooltip.current && (devices || updateRequired)) {
      (0, import_components_core24.computeMenuPosition)(button.current, tooltip.current).then(({ x: x2, y: y2 }) => {
        if (tooltip.current) {
  ...
  const handleClickOutside = React38.useCallback(
    (event) => {
      if (!tooltip.current) {
        return;
      }
  ...
  return /* @__PURE__ */ React38.createElement(React38.Fragment, null, /* @__PURE__ */ React38.createElement(
    ...
    props.children
  ), !props.disabled && /* @__PURE__ */ React38.createElement(
    "div",
    {
    ...
    kind ? /* @__PURE__ */ React38.createElement(
      MediaDeviceSelect,
      {
        initialSelection,
    ...
    ) : /* @__PURE__ */ React38.createElement(React38.Fragment, null, /* @__PURE__ */ React38.createElement("div", { className: "lk-device-menu-heading" }, "Audio inputs"), /* @__PURE__ */ React38.createElement(
      MediaDeviceSelect,
      {
        kind: "audioinput",
    ...
    ), /* @__PURE__ */ React38.createElement("div", { className: "lk-device-menu-heading" }, "Video inputs"), /* @__PURE__ */ React38.createElement(
      MediaDeviceSelect,
      {
        kind: "videoinput",
...
var SvgChatIcon = (props) => /* @__PURE__ */ React39.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 18, fill: "none" }, props), /* @__PURE__ */ React39.createElement(
  "path",
  {
    fill: "currentColor",
    fillRule: "evenodd",
...
var SvgChevron = (props) => /* @__PURE__ */ React40.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "none" }, props), /* @__PURE__ */ React40.createElement(
  "path",
  {
    fill: "currentcolor",
    fillRule: "evenodd",
...
var SvgFocusToggleIcon = (props) => /* @__PURE__ */ React41.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "none" }, props), /* @__PURE__ */ React41.createElement("g", { stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 1.5 }, /* @__PURE__ */ React41.createElement("path", { d: "M10 1.75h4.25m0 0V6m0-4.25L9 7M6 14.25H1.75m0 0V10m0 4.25L7 9" })));
var FocusToggleIcon_default = SvgFocusToggleIcon;

// src/assets/icons/LeaveIcon.tsx
var React42 = __toESM(require("react"));
var SvgLeaveIcon = (props) => /* @__PURE__ */ React42.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "none" }, props), /* @__PURE__ */ React42.createElement(
  "path",
  {
    fill: "currentColor",
    fillRule: "evenodd",
...
var SvgLockLockedIcon = (props) => /* @__PURE__ */ React43.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "none" }, props), /* @__PURE__ */ React43.createElement(
  "path",
  {
    fill: "currentcolor",
    fillRule: "evenodd",
...
var SvgQualityExcellentIcon = (props) => /* @__PURE__ */ React44.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "currentcolor" }, props), /* @__PURE__ */ React44.createElement("path", { d: "M0 11.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6-5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6-6a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" }), /* @__PURE__ */ React44.createElement("path", { d: "M0 11.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6-5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6-6a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" }));
var QualityExcellentIcon_default = SvgQualityExcellentIcon;

// src/assets/icons/QualityGoodIcon.tsx
var React45 = __toESM(require("react"));
var SvgQualityGoodIcon = (props) => /* @__PURE__ */ React45.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "currentcolor" }, props), /* @__PURE__ */ React45.createElement("path", { d: "M0 11.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6-5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" }), /* @__PURE__ */ React45.createElement("path", { d: "M0 11.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6-5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" }), /* @__PURE__ */ React45.createElement("g", { opacity: 0.25 }, /* @__PURE__ */ React45.createElement("path", { d: "M12 .5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" }), /* @__PURE__ */ React45.createElement("path", { d: "M12 .5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" })));
var QualityGoodIcon_default = SvgQualityGoodIcon;

// src/assets/icons/QualityPoorIcon.tsx
var React46 = __toESM(require("react"));
var SvgQualityPoorIcon = (props) => /* @__PURE__ */ React46.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "currentcolor" }, props), /* @__PURE__ */ React46.createElement("path", { d: "M0 11.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" }), /* @__PURE__ */ React46.createElement("path", { d: "M0 11.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" }), /* @__PURE__ */ React46.createElement("g", { opacity: 0.25 }, /* @__PURE__ */ React46.createElement("path", { d: "M6 6.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" }), /* @__PURE__ */ React46.createElement("path", { d: "M6 6.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6-6a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" }), /* @__PURE__ */ React46.createElement("path", { d: "M12 .5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" })));
var QualityPoorIcon_default = SvgQualityPoorIcon;

// src/assets/icons/QualityUnknownIcon.tsx
var React47 = __toESM(require("react"));
var SvgQualityUnknownIcon = (props) => /* @__PURE__ */ React47.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "currentColor" }, props), /* @__PURE__ */ React47.createElement("g", { opacity: 0.25 }, /* @__PURE__ */ React47.createElement("path", { d: "M0 11.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-4Zm6-5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-9Zm6-6a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5V.5Z" }), /* @__PURE__ */ React47.createElement("path", { d: "M0 11.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-4Zm6-5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-9Zm6-6a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5V.5Z" })));
var QualityUnknownIcon_default = SvgQualityUnknownIcon;

// src/assets/icons/ScreenShareIcon.tsx
var React48 = __toESM(require("react"));
var SvgScreenShareIcon = (props) => /* @__PURE__ */ React48.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 20, height: 16, fill: "none" }, props), /* @__PURE__ */ React48.createElement(
  "path",
  {
    fill: "currentColor",
    fillRule: "evenodd",
...
var SvgScreenShareStopIcon = (props) => /* @__PURE__ */ React49.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 20, height: 16, fill: "none" }, props), /* @__PURE__ */ React49.createElement("g", { fill: "currentColor" }, /* @__PURE__ */ React49.createElement("path", { d: "M7.28 4.22a.75.75 0 0 0-1.06 1.06L8.94 8l-2.72 2.72a.75.75 0 1 0 1.06 1.06L10 9.06l2.72 2.72a.75.75 0 1 0 1.06-1.06L11.06 8l2.72-2.72a.75.75 0 0 0-1.06-1.06L10 6.94z" }), /* @__PURE__ */ React49.createElement(
  "path",
  {
    fillRule: "evenodd",
...
var SvgSpinnerIcon = (props) => /* @__PURE__ */ React50.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "none" }, props), /* @__PURE__ */ React50.createElement(
  "path",
  {
    fill: "currentColor",
    fillRule: "evenodd",
...
var SvgCameraIcon = (props) => /* @__PURE__ */ React53.createElement(
  "svg",
  __spreadValues({
    width: 18,
    height: 18,
...
var SvgMicDisabledIcon = (props) => /* @__PURE__ */ React54.createElement(
  "svg",
  __spreadValues({
    width: 18,
    height: 18,
...
var SvgMicIcon = (props) => /* @__PURE__ */ React55.createElement(
  "svg",
  __spreadValues({
    width: 18,
    height: 18,
...
function getSourceIcon(source, enabled) {
  switch (source) {
    case import_livekit_client6.Track.Source.Microphone:
      return enabled ? /* @__PURE__ */ React56.createElement(MicIcon_default, null) : /* @__PURE__ */ React56.createElement(MicDisabledIcon_default, null);
    case import_livekit_client6.Track.Source.Camera:
      return enabled ? /* @__PURE__ */ React56.createElement(CameraIcon_default, null) : /* @__PURE__ */ React56.createElement(CameraDisabledIcon_default, null);
    case import_livekit_client6.Track.Source.ScreenShare:
      return enabled ? /* @__PURE__ */ React56.createElement(ScreenShareStopIcon_default, null) : /* @__PURE__ */ React56.createElement(ScreenShareIcon_default, null);
    default:
      return void 0;
  }
}
function getConnectionQualityIcon(quality) {
  switch (quality) {
    case import_livekit_client6.ConnectionQuality.Excellent:
      return /* @__PURE__ */ React56.createElement(QualityExcellentIcon_default, null);
    case import_livekit_client6.ConnectionQuality.Good:
      return /* @__PURE__ */ React56.createElement(QualityGoodIcon_default, null);
    case import_livekit_client6.ConnectionQuality.Poor:
      return /* @__PURE__ */ React56.createElement(QualityPoorIcon_default, null);
    default:
      return /* @__PURE__ */ React56.createElement(QualityUnknownIcon_default, null);
  }
}

// src/components/controls/TrackToggle.tsx
function TrackToggle(_a2) {
  var _b = _a2, { showIcon } = _b, props = __objRest(_b, ["showIcon"]);
  const { buttonProps, enabled } = useTrackToggle(props);
  return /* @__PURE__ */ React57.createElement("button", __spreadValues({}, buttonProps), (showIcon != null ? showIcon : true) && getSourceIcon(props.source, enabled), props.children);
}
...
var SvgParticipantPlaceholder = (props) => /* @__PURE__ */ React58.createElement(
  "svg",
  __spreadValues({
    width: 320,
    height: 320,
...
function usePreviewTracks(options, onError) {
  const [tracks, setTracks] = React59.useState();
  React59.useEffect(() => {
...
function usePreviewDevice(enabled, deviceId, kind) {
  const [deviceError, setDeviceError] = React59.useState(null);
  const [isCreatingTrack, setIsCreatingTrack] = React59.useState(false);
  const devices = useMediaDevices({ kind });
  const [selectedDevice, setSelectedDevice] = React59.useState(
    void 0
  );
  const [localTrack, setLocalTrack] = React59.useState();
  const [localDeviceId, setLocalDeviceId] = React59.useState(deviceId);
  React59.useEffect(() => {
  ...
  const prevDeviceId = React59.useRef(localDeviceId);
  React59.useEffect(() => {
...
function PreJoin(_a2) {
  ...
  const [userChoices, setUserChoices] = React59.useState(DEFAULT_USER_CHOICES);
  const [username, setUsername] = React59.useState(
    (_a3 = defaults.username) != null ? _a3 : DEFAULT_USER_CHOICES.username
  );
  const [videoEnabled, setVideoEnabled] = React59.useState(
    (_b2 = defaults.videoEnabled) != null ? _b2 : DEFAULT_USER_CHOICES.videoEnabled
  );
  const initialVideoDeviceId = (_c2 = defaults.videoDeviceId) != null ? _c2 : DEFAULT_USER_CHOICES.videoDeviceId;
  const [videoDeviceId, setVideoDeviceId] = React59.useState(initialVideoDeviceId);
  const initialAudioDeviceId = (_d = defaults.audioDeviceId) != null ? _d : DEFAULT_USER_CHOICES.audioDeviceId;
  const [audioEnabled, setAudioEnabled] = React59.useState(
    (_e2 = defaults.audioEnabled) != null ? _e2 : DEFAULT_USER_CHOICES.audioEnabled
  );
  const [audioDeviceId, setAudioDeviceId] = React59.useState(initialAudioDeviceId);
  const [e2ee, setE2ee] = React59.useState((_f = defaults.e2ee) != null ? _f : DEFAULT_USER_CHOICES.e2ee);
  const [sharedPassphrase, setSharedPassphrase] = React59.useState(
  ...
  const videoEl = React59.useRef(null);
  const videoTrack = React59.useMemo(
    () => tracks == null ? void 0 : tracks.filter((track) => track.kind === import_livekit_client7.Track.Kind.Video)[0],
    [tracks]
  );
  const facingMode = React59.useMemo(() => {
    if (videoTrack) {
  ...
  const audioTrack = React59.useMemo(
  ...
  const [isValid, setIsValid] = React59.useState();
  const handleValidation = React59.useCallback(
    (values) => {
  ...
  return /* @__PURE__ */ React59.createElement("div", __spreadValues({ className: "lk-prejoin" }, htmlProps), /* @__PURE__ */ React59.createElement("div", { className: "lk-video-container" }, videoTrack && /* @__PURE__ */ React59.createElement("video", { ref: videoEl, width: "1280", height: "720", "data-lk-facing-mode": facingMode }), (!videoTrack || !videoEnabled) && /* @__PURE__ */ React59.createElement("div", { className: "lk-camera-off-note" }, /* @__PURE__ */ React59.createElement(ParticipantPlaceholder_default, null))), /* @__PURE__ */ React59.createElement("div", { className: "lk-button-group-container" }, /* @__PURE__ */ React59.createElement("div", { className: "lk-button-group audio" }, /* @__PURE__ */ React59.createElement(
    TrackToggle,
    {
    ...
    micLabel
  ), /* @__PURE__ */ React59.createElement("div", { className: "lk-button-group-menu" }, /* @__PURE__ */ React59.createElement(
    MediaDeviceMenu,
    {
  ...
  ))), /* @__PURE__ */ React59.createElement("div", { className: "lk-button-group video" }, /* @__PURE__ */ React59.createElement(
    TrackToggle,
    {
  ...
  )))), /* @__PURE__ */ React59.createElement("form", { className: "lk-username-container" }, /* @__PURE__ */ React59.createElement(
    "input",
    {
  ...
  ), showE2EEOptions && /* @__PURE__ */ React59.createElement("div", { style: { display: "flex", flexDirection: "column", gap: "1rem" } }, /* @__PURE__ */ React59.createElement("div", { style: { display: "flex", flexDirection: "row", gap: "1rem" } }, /* @__PURE__ */ React59.createElement(
    "input",
    {
      id: "use-e2ee",
      type: "checkbox",
  ...
  ), /* @__PURE__ */ React59.createElement("label", { htmlFor: "use-e2ee" }, "Enable end-to-end encryption")), e2ee && /* @__PURE__ */ React59.createElement("div", { style: { display: "flex", flexDirection: "row", gap: "1rem" } }, /* @__PURE__ */ React59.createElement("label", { htmlFor: "passphrase" }, "Passphrase"), /* @__PURE__ */ React59.createElement(
    "input",
    {
      id: "passphrase",
      type: "password",
    ...
    joinLabel
  )), debug && /* @__PURE__ */ React59.createElement(React59.Fragment, null, /* @__PURE__ */ React59.createElement("strong", null, "User Choices:"), /* @__PURE__ */ React59.createElement("ul", { className: "lk-list", style: { overflow: "hidden", maxWidth: "15rem" } }, /* @__PURE__ */ React59.createElement("li", null, "Username: ", `${userChoices.username}`), /* @__PURE__ */ React59.createElement("li", null, "Video Enabled: ", `${userChoices.videoEnabled}`), /* @__PURE__ */ React59.createElement("li", null, "Audio Enabled: ", `${userChoices.audioEnabled}`), /* @__PURE__ */ React59.createElement("li", null, "Video Device: ", `${userChoices.videoDeviceId}`), /* @__PURE__ */ React59.createElement("li", null, "Audio Device: ", `${userChoices.audioDeviceId}`))));
}
...
function useToggleShareLink({ props }) {
  const { dispatch, state } = useLayoutContext().widget;
  const { className } = React61.useMemo(() => (0, import_components_core27.setupShareLinkToggle)(), []);
...
function DisconnectButton(props) {
  ...
  return /* @__PURE__ */ React62.createElement("button", __spreadValues({}, buttonProps), props.children);
}

// src/components/controls/FocusToggle.tsx
var React63 = __toESM(require("react"));
function FocusToggle(_a2) {
  var _b = _a2, { trackRef, trackSource, participant } = _b, props = __objRest(_b, ["trackRef", "trackSource", "participant"]);
...
function StartAudio(_a2) {
  var _b = _a2, { label = "Allow Audio" } = _b, props = __objRest(_b, ["label"]);
  const room = useRoomContext();
  const { mergedProps } = useStartAudio({ room, props });
  return /* @__PURE__ */ React64.createElement("button", __spreadValues({}, mergedProps), label);
}
...
function ConnectionQualityIndicator(props) {
  ...
  return /* @__PURE__ */ React65.createElement("div", __spreadValues({}, elementProps), (_a2 = props.children) != null ? _a2 : getConnectionQualityIcon(quality));
}

// src/components/participant/ParticipantName.tsx
var import_components_core28 = require("@livekit/components-core");
var React66 = __toESM(require("react"));
function ParticipantName(_a2) {
  var _b = _a2, { participant } = _b, props = __objRest(_b, ["participant"]);
  const p2 = useEnsureParticipant(participant);
  const { className, infoObserver } = React66.useMemo(() => {
    return (0, import_components_core28.setupParticipantName)(p2);
  }, [p2]);
  ...
  const mergedProps = React66.useMemo(() => {
    return mergeProps2(props, { className, "data-lk-participant-name": name });
  }, [props, className, name]);
  return /* @__PURE__ */ React66.createElement("span", __spreadValues({}, mergedProps), name !== "" ? name : identity, props.children);
}

// src/components/participant/TrackMutedIndicator.tsx
var React67 = __toESM(require("react"));
function TrackMutedIndicator(_a2) {
  var _b = _a2, {
    source,
    participant,
    trackRef,
  ...
  const htmlProps = React67.useMemo(
    () => mergeProps2(props, {
      className
    }),
    [className, props]
  ...
  return /* @__PURE__ */ React67.createElement("div", __spreadProps(__spreadValues({}, htmlProps), { "data-lk-muted": isMuted }), (_b2 = props.children) != null ? _b2 : getSourceIcon((_a3 = trackRef == null ? void 0 : trackRef.source) != null ? _a3 : source, !isMuted));
}
...
function VideoTrack(_a2) {
  ...
  var _a3, _b2, _c2, _d, _e2, _f, _g, _h, _i2, _j;
  const maybeTrackRef = useMaybeTrackRefContext();
  const _name = (_d = (_c2 = (_a3 = trackRef == null ? void 0 : trackRef.publication) == null ? void 0 : _a3.trackName) != null ? _c2 : (_b2 = maybeTrackRef == null ? void 0 : maybeTrackRef.publication) == null ? void 0 : _b2.trackName) != null ? _d : name;
  const _source = (_f = (_e2 = trackRef == null ? void 0 : trackRef.source) != null ? _e2 : maybeTrackRef == null ? void 0 : maybeTrackRef.source) != null ? _f : source;
  ...
  const _participant = (_j = (_i2 = trackRef == null ? void 0 : trackRef.participant) != null ? _i2 : maybeTrackRef == null ? void 0 : maybeTrackRef.participant) != null ? _j : p2;
  if (_source === void 0) {
  ...
  return /* @__PURE__ */ React68.createElement("video", __spreadProps(__spreadValues({ ref: mediaEl }, elementProps), { muted: true, onClick: clickHandler }));
}
...
function AudioTrack(_a2) {
  ...
  return /* @__PURE__ */ React69.createElement("audio", __spreadValues({ ref: mediaEl }, elementProps));
}
...
function useIsEncrypted(participant) {
  ...
  const observer = React70.useMemo(() => (0, import_components_core30.encryptionStatusObservable)(room, p2), [room, p2]);
  const isEncrypted = useObservableState(
    observer,
    p2 instanceof import_livekit_client10.LocalParticipant ? p2.isE2EEEnabled : p2.isEncrypted
  );
  return isEncrypted;
}
...
function WhiteboardTrack() {
  return /* @__PURE__ */ React71.createElement("iframe", { src: getURL(), width: "100%", height: "100%" });
}
function getURL() {
  const room = useRoomContext();
...
function ParticipantContextIfNeeded(props) {
  ...
  return props.participant && !hasContext ? /* @__PURE__ */ React72.createElement(ParticipantContext.Provider, { value: props.participant }, props.children) : /* @__PURE__ */ React72.createElement(React72.Fragment, null, props.children);
}
function TrackRefContextIfNeeded(props) {
  const hasContext = !!useMaybeTrackRefContext();
  return props.trackRef && !hasContext ? /* @__PURE__ */ React72.createElement(TrackRefContext.Provider, { value: props.trackRef }, props.children) : /* @__PURE__ */ React72.createElement(React72.Fragment, null, props.children);
}
function ParticipantTile(_a2) {
  var _b = _a2, {
    trackRef,
    participant,
    children,
  ...
  const maybeTrackRef = useMaybeTrackRefContext();
  const p2 = useEnsureParticipant(participant);
  const trackReference = React72.useMemo(() => {
    var _a4, _b3, _c3, _d, _e2, _f;
    return {
      participant: (_b3 = (_a4 = trackRef == null ? void 0 : trackRef.participant) != null ? _a4 : maybeTrackRef == null ? void 0 : maybeTrackRef.participant) != null ? _b3 : p2,
      source: (_d = (_c3 = trackRef == null ? void 0 : trackRef.source) != null ? _c3 : maybeTrackRef == null ? void 0 : maybeTrackRef.source) != null ? _d : source,
      publication: (_f = (_e2 = trackRef == null ? void 0 : trackRef.publication) != null ? _e2 : maybeTrackRef == null ? void 0 : maybeTrackRef.publication) != null ? _f : publication
    };
  }, [maybeTrackRef, p2, publication, source, trackRef]);
  ...
  return /* @__PURE__ */ React72.createElement("div", __spreadValues({ style: { position: "relative" } }, elementProps), /* @__PURE__ */ React72.createElement(TrackRefContextIfNeeded, { trackRef: trackReference }, /* @__PURE__ */ React72.createElement(ParticipantContextIfNeeded, { participant: trackReference.participant }, children != null ? children : /* @__PURE__ */ React72.createElement(React72.Fragment, null, ((_b2 = trackReference.publication) == null ? void 0 : _b2.trackName) == "whiteboard" ? /* @__PURE__ */ React72.createElement(WhiteboardTrack, null) : (0, import_components_core31.isTrackReference)(trackReference) && (((_c2 = trackReference.publication) == null ? void 0 : _c2.kind) === "video" || trackReference.source === import_livekit_client11.Track.Source.Camera || trackReference.source === import_livekit_client11.Track.Source.ScreenShare) ? /* @__PURE__ */ React72.createElement(
    VideoTrack,
    {
  ...
  ) : (0, import_components_core31.isTrackReference)(trackReference) && /* @__PURE__ */ React72.createElement(
    AudioTrack,
    {
      trackRef: trackReference,
      onSubscriptionStatusChanged: handleSubscribe
    }
  ), /* @__PURE__ */ React72.createElement("div", { className: "lk-participant-placeholder" }, /* @__PURE__ */ React72.createElement(ParticipantPlaceholder_default, null)), /* @__PURE__ */ React72.createElement("div", { className: "lk-participant-metadata" }, /* @__PURE__ */ React72.createElement("div", { className: "lk-participant-metadata-item" }, trackReference.source === import_livekit_client11.Track.Source.Camera ? /* @__PURE__ */ React72.createElement(React72.Fragment, null, isEncrypted && /* @__PURE__ */ React72.createElement(LockLockedIcon_default, { style: { marginRight: "0.25rem" } }), /* @__PURE__ */ React72.createElement(
    TrackMutedIndicator,
    {
      source: import_livekit_client11.Track.Source.Microphone,
      show: "muted"
    }
  ), /* @__PURE__ */ React72.createElement(ParticipantName, null)) : /* @__PURE__ */ React72.createElement(React72.Fragment, null, /* @__PURE__ */ React72.createElement(ScreenShareIcon_default, { style: { marginRight: "0.25rem" } }), /* @__PURE__ */ React72.createElement(ParticipantName, null, "'s screen"))), /* @__PURE__ */ React72.createElement(ConnectionQualityIndicator, { className: "lk-participant-metadata-item" }))), /* @__PURE__ */ React72.createElement(FocusToggle, { trackRef: trackReference }))));
}

// src/components/layout/FocusLayout.tsx
function FocusLayoutContainer(props) {
  const elementProps = mergeProps2(props, { className: "lk-focus-layout" });
  return /* @__PURE__ */ React73.createElement("div", __spreadValues({}, elementProps), props.children);
}
function FocusLayout(_a2) {
  var _b = _a2, { trackRef, track } = _b, htmlProps = __objRest(_b, ["trackRef", "track"]);
  const trackReference = trackRef != null ? trackRef : track;
  return /* @__PURE__ */ React73.createElement(ParticipantTile, __spreadValues(__spreadValues({}, trackReference), htmlProps));
}
...
function TrackLoop(_a2) {
  ...
  return /* @__PURE__ */ React74.createElement(React74.Fragment, null, tracks.map((trackReference) => {
...
function PaginationControl({
  ...
  const [interactive, setInteractive] = React75.useState(false);
  React75.useEffect(() => {
    let subscription;
    if (connectedElement) {
  ...
  return /* @__PURE__ */ React75.createElement("div", { className: "lk-pagination-control", "data-lk-user-interaction": interactive }, /* @__PURE__ */ React75.createElement("button", { className: "lk-button", onClick: prevPage }, /* @__PURE__ */ React75.createElement(Chevron_default, null)), /* @__PURE__ */ React75.createElement("span", { className: "lk-pagination-count" }, `${currentPage} of ${totalPageCount}`), /* @__PURE__ */ React75.createElement("button", { className: "lk-button", onClick: nextPage }, /* @__PURE__ */ React75.createElement(Chevron_default, null)));
}
...
function PaginationIndicator({ totalPageCount, currentPage }) {
  const bubbles = new Array(totalPageCount).fill("").map((_2, index) => {
    if (index + 1 === currentPage) {
      return /* @__PURE__ */ React76.createElement("span", { "data-lk-active": true, key: index });
    } else {
      return /* @__PURE__ */ React76.createElement("span", { key: index });
    }
  });
  return /* @__PURE__ */ React76.createElement("div", { className: "lk-pagination-indicator" }, bubbles);
}

// src/components/layout/GridLayout.tsx
function GridLayout(_a2) {
  var _b = _a2, { tracks } = _b, props = __objRest(_b, ["tracks"]);
  const gridEl = React77.createRef();
  ...
  return /* @__PURE__ */ React77.createElement("div", __spreadValues({ ref: gridEl, "data-lk-pagination": pagination.totalPageCount > 1 }, elementProps), /* @__PURE__ */ React77.createElement(TrackLoop, { tracks: pagination.tracks }, props.children), tracks.length > layout.maxTiles && /* @__PURE__ */ React77.createElement(React77.Fragment, null, /* @__PURE__ */ React77.createElement(
    PaginationIndicator,
    {
      totalPageCount: pagination.totalPageCount,
      currentPage: pagination.currentPage
    }
  ), /* @__PURE__ */ React77.createElement(PaginationControl, __spreadValues({ pagesContainer: gridEl }, pagination))));
}
...
function CarouselLayout(_a2) {
  ...
  const asideEl = React78.useRef(null);
  const [prevTiles, setPrevTiles] = React78.useState(0);
  ...
  return /* @__PURE__ */ React78.createElement("aside", __spreadValues({ key: carouselOrientation, className: "lk-carousel", ref: asideEl }, props), /* @__PURE__ */ React78.createElement(TrackLoop, { tracks: sortedTiles }, props.children));
}
...
function LayoutContextProvider({
  ...
  React79.useEffect(() => {
    import_components_core35.log.debug("Whiteboard Updated", { state: layoutContextValue.whiteboard.state });
  ...
  return /* @__PURE__ */ React79.createElement(LayoutContext.Provider, { value: layoutContextValue }, children);
}

// src/components/participant/AudioVisualizer.tsx
var import_livekit_client12 = require("livekit-client");
var React80 = __toESM(require("react"));
function AudioVisualizer(_a2) {
  var _b = _a2, { participant, trackRef } = _b, props = __objRest(_b, ["participant", "trackRef"]);
  var _a3, _b2;
  ...
  const barCount = 7;
  const p2 = (_a3 = useMaybeParticipantContext()) != null ? _a3 : participant;
  ...
  if (!ref) {
    ...
    ref = { participant: p2, source: import_livekit_client12.Track.Source.Microphone };
  }
  ...
  React80.useEffect(() => {
    ...
    const calculateBars = () => {
      ...
      dataArray.slice(1);
      const binSize = 6;
      for (let i2 = 0; i2 < barCount / 2; i2 += 1) {
        const id = Math.floor(barCount / 2 - i2);
        for (let k2 = 0; k2 < binSize; k2 += 1) {
          sums[id] += Math.pow(dataArray[i2 * binSize + k2] / 255, 2);
        }
        sums[id] /= binSize;
      }
      for (let i2 = 0; i2 < barCount / 2; i2 += 1) {
      ...
      return sums.map((s2) => s2 * volMultiplier);
    };
...
function RoomAudioRenderer({ volume, muted }) {
  ...
  ).filter((ref) => !(0, import_components_core36.isLocal)(ref.participant) && ref.publication.kind === import_livekit_client13.Track.Kind.Audio);
  React82.useEffect(() => {
    for (const track of tracks) {
      track.publication.setSubscribed(true);
    }
  }, [tracks]);
  return /* @__PURE__ */ React82.createElement("div", { style: { display: "none" } }, tracks.map((trackRef) => /* @__PURE__ */ React82.createElement(
    AudioTrack,
    {
      key: (0, import_components_core36.getTrackReferenceId)(trackRef),
      trackRef,
      volume,
      muted
    }
...
function Toast(props) {
  const htmlProps = React83.useMemo(() => mergeProps2(props, { className: "lk-toast" }), [props]);
  return /* @__PURE__ */ React83.createElement("div", __spreadValues({}, htmlProps), props.children);
}

// src/components/participant/ParticipantAudioTile.tsx
var React84 = __toESM(require("react"));
var import_livekit_client14 = require("livekit-client");
function ParticipantAudioTile(_a2) {
  var _b = _a2, {
    participant,
    children,
    source,
  ...
  return /* @__PURE__ */ React84.createElement("div", __spreadValues({ style: { position: "relative" } }, elementProps), /* @__PURE__ */ React84.createElement(ParticipantContextIfNeeded, { participant: p2 }, children != null ? children : /* @__PURE__ */ React84.createElement(React84.Fragment, null, /* @__PURE__ */ React84.createElement(AudioTrack, { source: source != null ? source : import_livekit_client14.Track.Source.Microphone }), /* @__PURE__ */ React84.createElement(AudioVisualizer, null), /* @__PURE__ */ React84.createElement("div", { className: "lk-participant-metadata" }, /* @__PURE__ */ React84.createElement("div", { className: "lk-participant-metadata-item" }, /* @__PURE__ */ React84.createElement(TrackMutedIndicator, { source: import_livekit_client14.Track.Source.Microphone }), /* @__PURE__ */ React84.createElement(ParticipantName, null)), /* @__PURE__ */ React84.createElement(ConnectionQualityIndicator, { className: "lk-participant-metadata-item" })))));
}
...
function ConnectionStateToast(props) {
  const [notification, setNotification] = React85.useState(void 0);
  const state = useConnectionState(props.room);
  React85.useEffect(() => {
    switch (state) {
      case import_livekit_client15.ConnectionState.Reconnecting:
        setNotification(
          /* @__PURE__ */ React85.createElement(React85.Fragment, null, /* @__PURE__ */ React85.createElement(SpinnerIcon_default, { className: "lk-spinner" }), " Reconnecting")
        );
        break;
      case import_livekit_client15.ConnectionState.Connecting:
        setNotification(
          /* @__PURE__ */ React85.createElement(React85.Fragment, null, /* @__PURE__ */ React85.createElement(SpinnerIcon_default, { className: "lk-spinner" }), " Connecting")
        );
        break;
      case import_livekit_client15.ConnectionState.Disconnected:
        setNotification(/* @__PURE__ */ React85.createElement(React85.Fragment, null, "Disconnected"));
        break;
      default:
  ...
  return notification ? /* @__PURE__ */ React85.createElement(Toast, { className: "lk-toast-connection-state" }, notification) : /* @__PURE__ */ React85.createElement(React85.Fragment, null);
}
...
function formatChatMessageLinks(message) {
  return (0, import_components_core37.tokenize)(message, (0, import_components_core37.createDefaultGrammar)()).map((tok, i2) => {
    if (typeof tok === `string`) {
      const html = nl2br(tok, false);
      return /* @__PURE__ */ React86.createElement("span", { key: i2, dangerouslySetInnerHTML: { __html: html } });
    } else {
      const content = tok.content.toString();
      const href = tok.type === `url` ? /^http(s?):\/\//.test(content) ? content : `https://${content}` : `mailto:${content}`;
      return /* @__PURE__ */ React86.createElement("a", { className: "lk-chat-link", key: i2, href, target: "_blank", rel: "noreferrer" }, content);
    }
  });
}
...
function HostEndMeetingMenu(_a2) {
  ...
  const [updateRequired, setUpdateRequired] = React87.useState(true);
  const room = useRoomContext();
  const button = React87.useRef(null);
  const leaveButtonRef = React87.useRef(null);
  const tooltip = React87.useRef(null);
  const { disconnect } = (0, import_components_core38.setupDisconnectButton)(room);
  const [showDropdown, setShowDropdown] = React87.useState(false);
  const [value, setValue] = React87.useState("");
  ...
  React87.useLayoutEffect(() => {
    if (button.current && tooltip.current && updateRequired) {
      (0, import_components_core38.computeMenuPosition)(button.current, tooltip.current).then(({ x: x2, y: y2 }) => {
        if (tooltip.current) {
  ...
  const handleClickOutside = React87.useCallback(
    (event) => {
      if (!tooltip.current) {
        return;
      }
  ...
  const [hostError, setHostError] = React87.useState(false);
  const handleChange = () => {
    if (value !== "") {
      setIsOpen(false);
      setValue(value);
  ...
  return /* @__PURE__ */ React87.createElement(React87.Fragment, null, /* @__PURE__ */ React87.createElement(
    ...
    /* @__PURE__ */ React87.createElement("ul", { className: "lk-media-device-select lk-list", style: { display: !showDropdown ? "unset" : "none" } }, endForAll && /* @__PURE__ */ React87.createElement("li", null, /* @__PURE__ */ React87.createElement(DisconnectButton, { onClick: endMeeting }, endForAll)), leave && /* @__PURE__ */ React87.createElement("li", null, /* @__PURE__ */ React87.createElement("button", { ref: leaveButtonRef, className: "lk-disconnect-button", onClick: handleLeave }, "Leave Meeting"))),
    showDropdown && /* @__PURE__ */ React87.createElement("div", { className: "assign-menu" }, hostError && /* @__PURE__ */ React87.createElement("span", { className: "text-invalid" }, "Must have to select participant"), /* @__PURE__ */ React87.createElement("select", { value, onChange: handleChangeValue }, /* @__PURE__ */ React87.createElement("option", { value: "" }, "Select meeting host"), remoteParticipants.map((participant) => /* @__PURE__ */ React87.createElement("option", { value: participant.identity, key: participant.identity }, participant == null ? void 0 : participant.name))), /* @__PURE__ */ React87.createElement("div", { className: "button-container" }, /* @__PURE__ */ React87.createElement("button", { className: "lk-button tl-cancel", onClick: handleCancel }, "Cancel"), /* @__PURE__ */ React87.createElement("button", { className: "lk-button tl-ok", onClick: handleChange }, "Ok"))),
    /* @__PURE__ */ React87.createElement("div", { className: "arrow" }, /* @__PURE__ */ React87.createElement("div", { className: "arrow-shape" }))
  ));
}
...
function useToggleUserLink({ props }) {
  const { dispatch, state } = useLayoutContext().widget;
  const { className } = React88.useMemo(() => (0, import_components_core39.setupUserToggle)(), []);
  const mergedProps = React88.useMemo(
    () => mergeProps2(props, {
      className,
      onClick: () => {
        if (dispatch)
...
function UserToggle(props) {
  ...
  return /* @__PURE__ */ React88.createElement("button", __spreadValues({}, mergedProps), props.children);
}

// src/assets/icons/InviteIcon.tsx
var React89 = __toESM(require("react"));
var SvgInviteIcon = (props) => /* @__PURE__ */ React89.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 25, height: 20, fill: "none" }, props), /* @__PURE__ */ React89.createElement(
  "path",
  {
...
var SvgUserIcon = (props) => /* @__PURE__ */ React90.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 20, height: 20, fill: "none" }, props), /* @__PURE__ */ React90.createElement(
  "path",
  {
    id: "Vector",
...
function BlurIndicater({ source }) {
  ...
  const room = useRoomContext();
  const [isBlur, setIsBlur] = import_react.default.useState(false);
  const toggleBlur = () => __async(this, null, function* () {
    var _a2;
    if (!room)
      return;
    try {
      const camTrack = room.localParticipant.getTrack(source).track;
  ...
  return /* @__PURE__ */ import_react.default.createElement("button", { className: "tl-blur lk-button", onClick: toggleBlur }, isBlur ? "Remove Blur" : "Blur Background");
}
...
function WhiteboardIndicater({
  ...
  return /* @__PURE__ */ import_react2.default.createElement("button", { disabled: isWhiteboard, className: "tl-blur lk-button", onClick: toggleWhiteboard }, "Whiteboard ", state == null ? void 0 : state.show_whiteboard);
}
...
function ExtraOptionMenu(_a2) {
  ...
  const [isOpen, setIsOpen] = React93.useState(false);
  const [updateRequired, setUpdateRequired] = React93.useState(true);
  const button = React93.useRef(null);
  const blurButtonRef = React93.useRef(null);
  const tooltip = React93.useRef(null);
  const [showDropdown, setShowDropdown] = React93.useState(false);
  React93.useLayoutEffect(() => {
    if (button.current && tooltip.current && updateRequired) {
      (0, import_components_core40.computeMenuPosition)(button.current, tooltip.current).then(({ x: x2, y: y2 }) => {
        if (tooltip.current) {
          Object.assign(tooltip.current.style, { left: `${x2}px`, top: `${y2 + 5}px` });
        }
      });
  ...
  const handleClickOutside = React93.useCallback(
    (event) => {
      if (!tooltip.current) {
        return;
      }
      ...
      if (isOpen && (0, import_components_core40.wasClickOutside)(tooltip.current, event)) {
        setIsOpen(false);
        setShowDropdown(false);
      }
    },
  ...
  return /* @__PURE__ */ React93.createElement(React93.Fragment, null, /* @__PURE__ */ React93.createElement(
    ...
    /* @__PURE__ */ React93.createElement("ul", { className: "lk-media-device-select lk-list", style: { display: !showDropdown ? "unset" : "none" } }, /* @__PURE__ */ React93.createElement("li", null, /* @__PURE__ */ React93.createElement(WhiteboardIndicater, { isWhiteboard: whiteBoard })), blurEnabled && /* @__PURE__ */ React93.createElement("li", null, /* @__PURE__ */ React93.createElement(BlurIndicater, { source: import_livekit_client16.Track.Source.Camera }))),
    /* @__PURE__ */ React93.createElement("div", { className: "arrow" }, /* @__PURE__ */ React93.createElement("div", { className: "arrow-shape" }))
  ));
}
...
function ControlBar(_a2) {
  ...
  var _a3, _b2, _c2, _d, _e2, _f, _g;
  const layoutContext = useMaybeLayoutContext();
  const [isChatOpen, setIsChatOpen] = React94.useState(false);
  const [isShareLinkOpen, setIsShareLinkOpen] = React94.useState(false);
  const [isUserOpen, setIsUserOpen] = React94.useState(false);
  ...
  const showIcon = React94.useMemo(
    () => variation === "minimal" || variation === "verbose",
    [variation]
  );
  const showText = React94.useMemo(
    () => variation === "textOnly" || variation === "verbose",
    [variation]
  );
  const browserSupportsScreenSharing = (0, import_components_core41.supportsScreenSharing)();
  const [isScreenShareEnabled, setIsScreenShareEnabled] = React94.useState(false);
  ...
  return /* @__PURE__ */ React94.createElement("div", __spreadValues({}, htmlProps), visibleControls.microphone && /* @__PURE__ */ React94.createElement("div", { className: "lk-button-group" }, /* @__PURE__ */ React94.createElement(TrackToggle, { source: import_livekit_client17.Track.Source.Microphone, showIcon }, showText && "Microphone"), /* @__PURE__ */ React94.createElement("div", { className: "lk-button-group-menu" }, /* @__PURE__ */ React94.createElement(MediaDeviceMenu, { kind: "audioinput" }))), visibleControls.camera && /* @__PURE__ */ React94.createElement("div", { className: "lk-button-group" }, /* @__PURE__ */ React94.createElement(TrackToggle, { source: import_livekit_client17.Track.Source.Camera, showIcon }, showText && "Camera"), /* @__PURE__ */ React94.createElement("div", { className: "lk-button-group-menu" }, /* @__PURE__ */ React94.createElement(MediaDeviceMenu, { kind: "videoinput" }))), visibleControls.screenShare && browserSupportsScreenSharing && /* @__PURE__ */ React94.createElement(
    TrackToggle,
    {
  ...
  ), visibleControls.chat && /* @__PURE__ */ React94.createElement(ChatToggle, null, showIcon && /* @__PURE__ */ React94.createElement(ChatIcon_default, null), showText && "Chat", state && state.unreadMessages !== 0 && /* @__PURE__ */ React94.createElement("span", { className: "waiting-count" }, state.unreadMessages < 10 ? state.unreadMessages.toFixed(0) : "9+")), visibleControls.sharelink && /* @__PURE__ */ React94.createElement(ShareLinkToggle, null, showIcon && /* @__PURE__ */ React94.createElement(InviteIcon_default, null), showText && "Invite"), visibleControls.users && /* @__PURE__ */ React94.createElement(UserToggle, null, showIcon && /* @__PURE__ */ React94.createElement(UsersIcon_default, null), showText && "Participants", waitingRoomCount !== 0 && /* @__PURE__ */ React94.createElement("span", { className: "waiting-count" }, waitingRoomCount)), /* @__PURE__ */ React94.createElement("div", { className: "lk-button-group" }, /* @__PURE__ */ React94.createElement("div", { className: "lk-button-group-menu" }, /* @__PURE__ */ React94.createElement(
    ExtraOptionMenu,
    {
      blurEnabled: true,
      whiteBoard: isWhiteboard
    }
  ))), visibleControls.endForAll ? /* @__PURE__ */ React94.createElement("div", { className: "tl-leave lk-button-group" }, /* @__PURE__ */ React94.createElement("button", { className: "lk-disconnect-button" }, showIcon && /* @__PURE__ */ React94.createElement(LeaveIcon_default, null), showText && "Leave"), /* @__PURE__ */ React94.createElement("div", { className: "tl-leave-btn lk-button-group-menu" }, /* @__PURE__ */ React94.createElement(
    HostEndMeetingMenu,
    {
  ...
  ))) : /* @__PURE__ */ React94.createElement(DisconnectButton, null, showIcon && /* @__PURE__ */ React94.createElement(LeaveIcon_default, null), showText && visibleControls.leaveButton), /* @__PURE__ */ React94.createElement(StartAudio, { label: "Start Audio" }));
}
...
var ToggleSwitch = ({
  ...
  return /* @__PURE__ */ import_react3.default.createElement("div", { className: "toggle-switch" + (small ? " small-switch" : "") }, /* @__PURE__ */ import_react3.default.createElement(
    "input",
    {
      type: "checkbox",
      name,
  ...
  ), id ? /* @__PURE__ */ import_react3.default.createElement(
    "label",
    {
...
var SvgApproveIcon = (props) => /* @__PURE__ */ React97.createElement(
  "svg",
  __spreadValues({
    width: "15",
    height: "11",
...
var SvgRejectIcon = (props) => /* @__PURE__ */ React98.createElement(
  "svg",
  __spreadValues({
    width: "15",
    height: "11",
...
function Users(_a2) {
  ...
  const participants = useParticipants();
  const [waitingRoom, setWaitingRoom] = React99.useState([]);
  const [toggleWaiting, setToggleWaiting] = React99.useState(true);
  const room = useRoomContext();
  ...
  return /* @__PURE__ */ React99.createElement("div", __spreadProps(__spreadValues({}, props), { className: "lk-chat lk-users" }), /* @__PURE__ */ React99.createElement("div", { className: "lk-waitinroom" }, /* @__PURE__ */ React99.createElement("div", { className: "tl-waitingroom-heading" }, /* @__PURE__ */ React99.createElement("h3", null, "Waiting Room"), /* @__PURE__ */ React99.createElement("div", { className: "tl-toggle-switch" }, /* @__PURE__ */ React99.createElement(
    ToggleSwitch,
    {
      id: "toggleSwitch",
  ...
  )), toggleWaiting && waitingRoom.length ? /* @__PURE__ */ React99.createElement(
    "button",
    {
    ...
    "Approve All"
  ) : ""), waitingRoom.map((item) => /* @__PURE__ */ React99.createElement("div", { className: "tl-participant-li", key: item.username }, /* @__PURE__ */ React99.createElement("div", { className: "lk-participant-metadata" }, /* @__PURE__ */ React99.createElement("div", { className: "lk-participant-metadata-item" }, item.username), /* @__PURE__ */ React99.createElement("div", { className: "display-flex" }, /* @__PURE__ */ React99.createElement(
    "button",
    {
      className: "lk-button lk-waiting-room lk-success",
      onClick: () => admitUser(item.identity, "accepted")
    },
    /* @__PURE__ */ React99.createElement(ApproveIcon_default, null)
    ...
    /* @__PURE__ */ React99.createElement(RejectIcon_default, null)
  )))))), /* @__PURE__ */ React99.createElement("div", { className: "lk-participants" }, /* @__PURE__ */ React99.createElement("div", { className: "tl-participants-heading" }, /* @__PURE__ */ React99.createElement("h3", null, "Participants  ", /* @__PURE__ */ React99.createElement("span", null, "(", participants.length, ")"))), (participants == null ? void 0 : participants.length) ? /* @__PURE__ */ React99.createElement(ParticipantLoop, { participants }, /* @__PURE__ */ React99.createElement(ParticipantList, null)) : /* @__PURE__ */ React99.createElement("div", null, /* @__PURE__ */ React99.createElement("h5", null, "No Participants"))));
}
...
function ShareLink(_a2) {
  ...
  const { infoObserver } = React100.useMemo(() => {
    return (0, import_components_core42.setupParticipantName)(p2);
  }, [p2]);
...
function VideoConference(_a2) {
  ...
  var _a3, _b2;
  const [widgetState, setWidgetState] = React101.useState({
    showChat: null,
    unreadMessages: 0
  });
  const lastAutoFocusedScreenShareTrack = React101.useRef(null);
  const { localParticipant } = useLocalParticipant();
  const p2 = useEnsureParticipant(localParticipant);
  ...
  const [showShareButton, setShowShareButton] = React101.useState(false);
  const [showParticipantButton, setShowParticipantButton] = React101.useState(false);
  const [leaveButton, setLeaveButton] = React101.useState("Leave");
  const [endForAll, setEndForAll] = React101.useState(false);
  const meta = metadata ? JSON.parse(metadata) : {};
  const [waitingRoomCount, setWaitingRoomCount] = React101.useState(0);
  const tracks = useTracks(
    [
  ...
  const widgetUpdate = (state) => {
    import_components_core43.log.debug("updating widget state", state);
    setWidgetState(state);
  };
  const updateCount = (count) => {
    import_components_core43.log.debug("count ", count);
    setWaitingRoomCount(count);
  };
  const layoutContext = useCreateLayoutContext();
  const screenShareTracks = tracks.filter(import_components_core43.isTrackReference).filter((track) => track.publication.source === import_livekit_client19.Track.Source.ScreenShare);
  ...
  const carouselTracks = tracks.filter((track) => !(0, import_components_core43.isEqualTrackRef)(track, focusTrack));
  React101.useEffect(() => {
    if (meta && meta.host) {
  ...
  React101.useEffect(() => {
    ...
    if (screenShareTracks.some((track) => track.publication.isSubscribed) && lastAutoFocusedScreenShareTrack.current === null) {
      import_components_core43.log.debug("Auto set screen share focus:", { newScreenShareTrack: screenShareTracks[0] });
      ...
      import_components_core43.log.debug("Auto clearing screen share focus.");
  ...
  const [isWhiteboard, setIsWhiteboard] = React101.useState(false);
  room.on(import_livekit_client19.RoomEvent.DataReceived, (payload) => {
    var _a4, _b3, _c2, _d, _e2, _f;
    const strData = decoder.decode(payload);
    const str = JSON.parse(strData);
    if (str.openWhiteboard) {
      (_b3 = (_a4 = layoutContext.whiteboard).dispatch) == null ? void 0 : _b3.call(_a4, { msg: "show_whiteboard" });
      (_d = (_c2 = layoutContext.pin).dispatch) == null ? void 0 : _d.call(_c2, { msg: "set_pin", trackReference: whiteboardTrack });
      setIsWhiteboard(true);
    } else {
      (_f = (_e2 = layoutContext.whiteboard).dispatch) == null ? void 0 : _f.call(_e2, { msg: "hide_whiteboard" });
      setIsWhiteboard(false);
    }
  });
  return /* @__PURE__ */ React101.createElement("div", __spreadValues({ className: "lk-video-conference" }, props), (0, import_components_core43.isWeb)() && /* @__PURE__ */ React101.createElement(
    ...
    /* @__PURE__ */ React101.createElement("div", { className: "lk-video-conference-inner" }, !focusTrack ? /* @__PURE__ */ React101.createElement("div", { className: "lk-grid-layout-wrapper" }, /* @__PURE__ */ React101.createElement(GridLayout, { tracks }, /* @__PURE__ */ React101.createElement(ParticipantTile, null))) : /* @__PURE__ */ React101.createElement("div", { className: "lk-focus-layout-wrapper" }, /* @__PURE__ */ React101.createElement(FocusLayoutContainer, null, /* @__PURE__ */ React101.createElement(CarouselLayout, { tracks: carouselTracks }, /* @__PURE__ */ React101.createElement(ParticipantTile, null)), focusTrack && /* @__PURE__ */ React101.createElement(FocusLayout, { trackRef: focusTrack }))), /* @__PURE__ */ React101.createElement(
      ControlBar,
      {
        controls: {
          chat: true,
    ...
    showShareButton ? /* @__PURE__ */ React101.createElement(ShareLink, { style: {
      display: widgetState.showChat == "show_invite" ? "flex" : "none"
    } }) : /* @__PURE__ */ React101.createElement(React101.Fragment, null),
    showParticipantButton ? /* @__PURE__ */ React101.createElement(
      Users,
      {
  ...
  ), /* @__PURE__ */ React101.createElement(RoomAudioRenderer, null), /* @__PURE__ */ React101.createElement(ConnectionStateToast, null));
}
...
function AudioConference(_a2) {
  var props = __objRest(_a2, []);
  const [widgetState, setWidgetState] = React102.useState({
    showChat: null,
    unreadMessages: 0
  });
  const participants = useParticipants();
  return /* @__PURE__ */ React102.createElement(LayoutContextProvider, { onWidgetChange: setWidgetState }, /* @__PURE__ */ React102.createElement("div", __spreadValues({ className: "lk-audio-conference" }, props), /* @__PURE__ */ React102.createElement("div", { className: "lk-audio-conference-stage" }, /* @__PURE__ */ React102.createElement(ParticipantLoop, { participants }, /* @__PURE__ */ React102.createElement(ParticipantAudioTile, null))), /* @__PURE__ */ React102.createElement(
    ControlBar,
    {
      controls: { microphone: true, screenShare: false, camera: false, chat: true },
      waitingRoomCount: 0
    }
  ), widgetState.showChat == "show_chat" && /* @__PURE__ */ React102.createElement(Chat, null)));
}
