...
var VideoTrack = /* @__PURE__ */ React77.forwardRef(
  function VideoTrack2(_a2, ref) {
    ...
    React77.useImperativeHandle(ref, () => mediaEl.current);
    ...
    React77.useEffect(() => {
      if (manageSubscription && trackReference.publication instanceof import_livekit_client10.RemoteTrackPublication && (debouncedIntersectionEntry == null ? void 0 : debouncedIntersectionEntry.isIntersecting) === false && (intersectionEntry == null ? void 0 : intersectionEntry.isIntersecting) === false) {
        trackReference.publication.setSubscribed(false);
      }
    }, [debouncedIntersectionEntry, trackReference, manageSubscription]);
    React77.useEffect(() => {
      if (manageSubscription && trackReference.publication instanceof import_livekit_client10.RemoteTrackPublication && (intersectionEntry == null ? void 0 : intersectionEntry.isIntersecting) === true) {
...
var AudioTrack = /* @__PURE__ */ React78.forwardRef(
  function AudioTrack2(_a2, ref) {
    ...
    React78.useImperativeHandle(ref, () => mediaEl.current);
    const {
      elementProps,
      isSubscribed,
      track,
...
function WhiteboardTrack() {
  ...
  return url ? /* @__PURE__ */ React79.createElement("iframe", { src: url, width: "100%", height: "100%" }) : /* @__PURE__ */ React79.createElement(React79.Fragment, null);
}
...
var ParticipantTile = /* @__PURE__ */ React80.forwardRef(function ParticipantTile2(_a2, ref) {
  ...
  ), /* @__PURE__ */ React80.createElement("div", { className: "lk-participant-placeholder" }, /* @__PURE__ */ React80.createElement(ParticipantPlaceholder_default, null)), /* @__PURE__ */ React80.createElement("div", { className: "lk-participant-metadata" }, /* @__PURE__ */ React80.createElement("div", { className: "lk-participant-metadata-item" }, trackReference.source === import_livekit_client12.Track.Source.Camera ? /* @__PURE__ */ React80.createElement(React80.Fragment, null, isEncrypted && /* @__PURE__ */ React80.createElement(LockLockedIcon_default, { style: { marginRight: "0.25rem" } }), /* @__PURE__ */ React80.createElement(
    TrackMutedIndicator,
    {
      trackRef: {
        participant: trackReference.participant,
...
function RoomAudioRenderer({ volume, muted }) {
  ...
  ).filter((ref) => !(0, import_components_core38.isLocal)(ref.participant) && ref.publication.kind === import_livekit_client13.Track.Kind.Audio);
  React90.useEffect(() => {
...
function usePreviewTracks(options, onError) {
  ...
  const trackLock = React98.useMemo(() => new import_livekit_client15.Mutex(), []);
  React98.useEffect(() => {
    ...
    trackLock.lock().then((unlock) => __async(this, null, function* () {
      try {
        ...
        if (options.audio || options.video) {
          const localTracks = yield (0, import_livekit_client15.createLocalTracks)(options);
          if (needsCleanup) {
        ...
        if (onError && e2 instanceof Error) {
          ...
          import_components_core43.log.error(e2);
        }
      } finally {
        unlock();
      }
...
function PreJoin(_a2) {
  ...
  const [userChoices, setUserChoices] = React98.useState(defaultUserChoices);
...
function useToggleUserLink({ props }) {
  const { dispatch, state } = useLayoutContext().widget;
  const { className } = React100.useMemo(() => (0, import_components_core45.setupUserToggle)(), []);
...
function ControlBar(_a2) {
  ...
  ))), visibleControls.camera && /* @__PURE__ */ React107.createElement("div", { className: "lk-button-group" }, /* @__PURE__ */ React107.createElement(TrackToggle, { source: import_livekit_client17.Track.Source.Camera, showIcon, onChange: cameraOnChange }, showText && "Camera"), /* @__PURE__ */ React107.createElement("div", { className: "lk-button-group-menu" }, /* @__PURE__ */ React107.createElement(
    MediaDeviceMenu,
    {
      kind: "videoinput",
...
function ShareLink(_a2) {
  ...
  return /* @__PURE__ */ React111.createElement("div", __spreadProps(__spreadValues({}, props), { className: "lk-chat lk-sharelink" }), /* @__PURE__ */ React111.createElement("form", { className: "lk-chat-form" }, /* @__PURE__ */ React111.createElement("input", { className: "lk-form-control lk-chat-form-input", type: "text", value: link, readOnly: true }), /* @__PURE__ */ React111.createElement("button", { type: "button", className: "lk-button lk-chat-form-button", onClick: handleCopy }, "Copy")), showToast ? /* @__PURE__ */ React111.createElement(Toast, { className: "lk-toast-connection-state" }, "Copied") : /* @__PURE__ */ React111.createElement(React111.Fragment, null), showInviteUser ? /* @__PURE__ */ React111.createElement("form", { className: "lk-chat-form", onSubmit: handleSubmit }, /* @__PURE__ */ React111.createElement(
    ...
    return /* @__PURE__ */ React111.createElement("li", { key: index, className: "lk-chat-entry" }, /* @__PURE__ */ React111.createElement("div", { className: "tl-list-user-box" }, /* @__PURE__ */ React111.createElement("span", { className: "lk-message-body" }, user.full_name, " ", user.ext_no ? ` - ${user.ext_no}` : ""), /* @__PURE__ */ React111.createElement("span", { className: "lk-message-body lk-message-text" }, user.designation)), /* @__PURE__ */ React111.createElement("button", { type: "button", onClick: () => handleInvite(user), className: "lk-button lk-chat-form-button tl-invite-button" + (user.invited ? " invited" : "") }, user.invited ? "Invited" : "Invite"));
  })) : "");
}
...
function VideoConference(_a2) {
  ...
  const updateCount = (count) => {
    import_components_core49.log.debug("count ", count);
    setWaitingRoomCount(count);
  };
  const layoutContext = useCreateLayoutContext();
  const screenShareTracks = tracks.filter(import_components_core49.isTrackReference).filter((track) => track.publication.source === import_livekit_client19.Track.Source.ScreenShare);
  ...
  useWarnAboutMissingStyles();
  return /* @__PURE__ */ React112.createElement("div", __spreadValues({ className: "lk-video-conference" }, props), (0, import_components_core49.isWeb)() && /* @__PURE__ */ React112.createElement(
