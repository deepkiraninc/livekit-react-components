...
function UserChat(_a) {
  ...
  return /* @__PURE__ */ React7.createElement(
    ...
    /* @__PURE__ */ React7.createElement("span", { className: "lk-meta-data" }, !hideName && /* @__PURE__ */ React7.createElement("strong", { className: "lk-participant-name" }, (_d = (_b2 = entry.from) == null ? void 0 : _b2.name) != null ? _d : (_c = entry.from) == null ? void 0 : _c.identity)),
...
function useToggleUserLink({ props }) {
  const { dispatch, state } = useLayoutContext().widget;
  const { className } = React83.useMemo(() => (0, import_components_core39.setupUserToggle)(), []);
...
function UserToggle(props) {
  ...
  return /* @__PURE__ */ React83.createElement("button", __spreadValues({}, mergedProps), props.children);
}
...
function ControlBar(_a) {
  ...
  const showIcon = React86.useMemo(
    () => variation === "minimal" || variation === "verbose",
    [variation]
  );
  const showText = React86.useMemo(
    () => variation === "textOnly" || variation === "verbose",
    [variation]
  );
  const browserSupportsScreenSharing = (0, import_components_core40.supportsScreenSharing)();
  const [isScreenShareEnabled, setIsScreenShareEnabled] = React86.useState(false);
  const onScreenShareChange = (enabled) => {
    setIsScreenShareEnabled(enabled);
  };
  const htmlProps = mergeProps2({ className: "lk-control-bar" }, props);
  return /* @__PURE__ */ React86.createElement("div", __spreadValues({}, htmlProps), visibleControls.microphone && /* @__PURE__ */ React86.createElement("div", { className: "lk-button-group" }, /* @__PURE__ */ React86.createElement(TrackToggle, { source: import_livekit_client16.Track.Source.Microphone, showIcon }, showText && "Microphone"), /* @__PURE__ */ React86.createElement("div", { className: "lk-button-group-menu" }, /* @__PURE__ */ React86.createElement(MediaDeviceMenu, { kind: "audioinput" }))), visibleControls.camera && /* @__PURE__ */ React86.createElement("div", { className: "lk-button-group" }, /* @__PURE__ */ React86.createElement(TrackToggle, { source: import_livekit_client16.Track.Source.Camera, showIcon }, showText && "Camera"), /* @__PURE__ */ React86.createElement("div", { className: "lk-button-group-menu" }, /* @__PURE__ */ React86.createElement(MediaDeviceMenu, { kind: "videoinput" }))), visibleControls.screenShare && browserSupportsScreenSharing && /* @__PURE__ */ React86.createElement(
    TrackToggle,
    {
  ...
  ))) : /* @__PURE__ */ React86.createElement(DisconnectButton, null, showIcon && /* @__PURE__ */ React86.createElement(LeaveIcon_default, null), showText && visibleControls.leaveButton), /* @__PURE__ */ React86.createElement(StartAudio, { label: "Start Audio" }));
}
...
function ShareLink(_a) {
  ...
  const ulRef = React87.useRef(null);
  const { link } = useGetLink();
  const [users, setUsers] = React87.useState([]);
  const [searched, setSearched] = React87.useState([]);
  const [showToast, setShowToast] = React87.useState(false);
  ...
  return /* @__PURE__ */ React87.createElement("div", __spreadProps(__spreadValues({}, props), { className: "lk-chat lk-sharelink" }), /* @__PURE__ */ React87.createElement("form", { className: "lk-chat-form" }, /* @__PURE__ */ React87.createElement("input", { className: "lk-form-control lk-chat-form-input", type: "text", value: link, readOnly: true }), /* @__PURE__ */ React87.createElement("button", { type: "button", className: "lk-button lk-chat-form-button", onClick: handleCopy }, "Copy")), showToast ? /* @__PURE__ */ React87.createElement(Toast, { className: "lk-toast-connection-state" }, "Copied") : /* @__PURE__ */ React87.createElement(React87.Fragment, null), /* @__PURE__ */ React87.createElement("form", { className: "lk-chat-form", onSubmit: handleSubmit }, /* @__PURE__ */ React87.createElement(
    "input",
    {
      className: "lk-form-control lk-chat-form-input",
      ref: inputRef,
  ...
  )), searched.length > 0 ? /* @__PURE__ */ React87.createElement("ul", { className: "lk-list lk-chat-messages", ref: ulRef }, searched.map((user, index) => {
    return /* @__PURE__ */ React87.createElement("li", { key: index, className: "lk-chat-entry" }, /* @__PURE__ */ React87.createElement("div", null, /* @__PURE__ */ React87.createElement("span", { className: "lk-message-body" }, user.full_name, " ", user.ext_no ? ` - ${user.ext_no}` : ""), /* @__PURE__ */ React87.createElement("span", { className: "lk-message-body lk-message-text" }, user.designation)), /* @__PURE__ */ React87.createElement("button", { type: "button", onClick: () => handleInvite(user), className: "lk-button lk-chat-form-button" + (user.invited ? " invited" : "") }, user.invited ? "Invited" : "Invite"));
  })) : "");
}
