...
function useIsEncrypted(participant) {
  ...
  const observer = React40.useMemo(() => encryptionStatusObservable(room, p), [room, p]);
...
function useToggleShareLink({ props }) {
  const { dispatch, state } = useLayoutContext().widget;
  const { className } = React43.useMemo(() => setupShareLinkToggle(), []);
...
var MediaDeviceSelect = /* @__PURE__ */ React61.forwardRef(function MediaDeviceSelect2(_a, ref) {
  var _b = _a, {
    kind,
    initialSelection,
...
// src/components/controls/TrackToggle.tsx
var TrackToggle = /* @__PURE__ */ React71.forwardRef(function TrackToggle2(_a, ref) {
...
var ConnectionQualityIndicator = /* @__PURE__ */ React72.forwardRef(function ConnectionQualityIndicator2(props, ref) {
  ...
  return /* @__PURE__ */ React72.createElement("div", __spreadValues({ ref }, elementProps), (_a = props.children) != null ? _a : getConnectionQualityIcon(quality));
});

// src/components/participant/ParticipantName.tsx
import { setupParticipantName } from "@livekit/components-core";
import * as React73 from "react";
var ParticipantName = /* @__PURE__ */ React73.forwardRef(function ParticipantName2(_a, ref) {
...
var TrackMutedIndicator = /* @__PURE__ */ React74.forwardRef(function TrackMutedIndicator2(_a, ref) {
  ...
  return /* @__PURE__ */ React74.createElement("div", __spreadProps(__spreadValues({ ref }, htmlProps), { "data-lk-muted": isMuted }), (_a2 = props.children) != null ? _a2 : getSourceIcon(trackRef.source, !isMuted));
});
...
function useMediaTrackBySourceOrName(observerOptions, options = {}) {
  var _a;
  const [publication, setPublication] = React76.useState(getTrackByIdentifier(observerOptions));
...
var ParticipantTile = /* @__PURE__ */ React80.forwardRef(function ParticipantTile2(_a, ref) {
  var _b = _a, {
    trackRef,
    children,
    onParticipantClick,
  ...
  ) : isTrackReference3(trackReference) && /* @__PURE__ */ React80.createElement(
    AudioTrack,
    {
      trackRef: trackReference,
      onSubscriptionStatusChanged: handleSubscribe
    }
  ), /* @__PURE__ */ React80.createElement("div", { className: "lk-participant-placeholder" }, /* @__PURE__ */ React80.createElement(ParticipantPlaceholder_default, null)), /* @__PURE__ */ React80.createElement("div", { className: "lk-participant-metadata" }, /* @__PURE__ */ React80.createElement("div", { className: "lk-participant-metadata-item" }, trackReference.source === Track4.Source.Camera ? /* @__PURE__ */ React80.createElement(React80.Fragment, null, isEncrypted && /* @__PURE__ */ React80.createElement(LockLockedIcon_default, { style: { marginRight: "0.25rem" } }), /* @__PURE__ */ React80.createElement(
    TrackMutedIndicator,
    {
      trackRef: {
...
function LayoutContextProvider({
  ...
  React87.useEffect(() => {
    log8.debug("Whiteboard Updated", { state: layoutContextValue.whiteboard.state });
...
var AudioVisualizer = /* @__PURE__ */ React88.forwardRef(function AudioVisualizer2(_a, ref) {
  var _b = _a, { trackRef } = _b, props = __objRest(_b, ["trackRef"]);
  const svgWidth = 200;
  const svgHeight = 90;
  const barWidth = 6;
...
var ParticipantAudioTile = /* @__PURE__ */ React92.forwardRef(function ParticipantAudioTile2(_a, ref) {
  var _b = _a, {
    children,
    disableSpeakingIndicator,
    onParticipantClick,
...
function formatChatMessageLinks(message) {
  return tokenize(message, createDefaultGrammar()).map((tok, i) => {
    if (typeof tok === `string`) {
      ...
      return /* @__PURE__ */ React94.createElement("span", { key: i, dangerouslySetInnerHTML: { __html: html } });
    } else {
...
import { RoomEvent as RoomEvent2, Track as Track10, TrackPublication } from "livekit-client";
...
function BlurIndicater({ source, parentCallback }) {
  ...
  return /* @__PURE__ */ React101.createElement("button", { className: "tl-blur lk-button", onClick: toggleBlur }, isBlur ? "Remove Blur" : "Blur Background");
}
...
function WhiteboardIndicater({
  ...
  return /* @__PURE__ */ React102.createElement("button", { disabled: disableWhiteboard, className: "tl-blur lk-button", onClick: toggleWhiteboard }, "Whiteboard ", state == null ? void 0 : state.show_whiteboard);
}
...
var StartMediaButton = /* @__PURE__ */ React104.forwardRef(function StartMediaButton2(_a, ref) {
...
function ControlBar(_a) {
  ...
  ))), visibleControls.camera && /* @__PURE__ */ React107.createElement("div", { className: "lk-button-group" }, /* @__PURE__ */ React107.createElement(TrackToggle, { source: Track8.Source.Camera, showIcon, onChange: cameraOnChange }, showText && "Camera"), /* @__PURE__ */ React107.createElement("div", { className: "lk-button-group-menu" }, /* @__PURE__ */ React107.createElement(
    MediaDeviceMenu,
    {
      kind: "videoinput",
...
var ToggleSwitch = ({
  ...
  return /* @__PURE__ */ React109.createElement("div", { className: "toggle-switch" + (small ? " small-switch" : "") }, /* @__PURE__ */ React109.createElement(
    "input",
    {
      type: "checkbox",
      name,
  ...
  ), id ? /* @__PURE__ */ React109.createElement(
    "label",
    {
...
function VideoConference(_a) {
  ...
  const whitePub = new TrackPublication(Track10.Kind.Unknown, "whiteboard", "whiteboard");
  const whiteboardTrack = {
    participant: p,
    publication: whitePub,
    source: Track10.Source.Unknown
  };
  ...
  useWarnAboutMissingStyles();
  return /* @__PURE__ */ React112.createElement("div", __spreadValues({ className: "lk-video-conference" }, props), isWeb() && /* @__PURE__ */ React112.createElement(
